# Sistema Controle de Obra - V44

Versão V44 com melhorias no Diário de Obra e no Cronograma Físico.
...
- Após substituir pela V44, rode `INSTALAR.bat` para instalar as novas dependências.
